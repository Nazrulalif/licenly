    ...
    var initDatatable = function () {
        datatable = $("#table-1").DataTable({
            ...
            columns: [
                ...
                { data: "key_size", name: "key_size", searchable: false, orderable: true },
                { data: "generated_at", name: "generated_at", searchable: false, orderable: true },
                {
                    data: "action",
                    name: "actions",
                    orderable: false,
